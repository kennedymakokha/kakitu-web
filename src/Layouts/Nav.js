...
function Nav(props) {
    return (
        <div className="flex font-Open flex-row justify-start  items-center py-0 bg-base-300">
            ...
            <input type='text' placeholder="search" className='placeholder-gray-300' style={{ height: 40, width: '45%', padding: 20, borderRadius: 5, backgroundColor: 'transparent', border: '1px solid rgba(255, 255, 255, 0.5)' }} />
                ...
                <ul className="">
                    ...
                    <li className="inline-block ">
                        <Menu as="div" className=" hidden md:inline-block relative  text-left">
                            ...
                            >
                                <Menu.Items className="absolute right-0 w-40 mt-2 origin-top-right bg-black divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <Foundation icon={<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2 9.5A3.5 3.5 0 005.5 13H9v2.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 15.586V13h2.5a4.5 4.5 0 10-.616-8.958 4.002 4.002 0 10-7.753 1.977A3.5 3.5 0 002 9.5zm9 3.5H9V8a1 1 0 012 0v5z" clip-rule="evenodd"></path></svg>} name="Android wallet" url="https://download2268.mediafire.com/3wxs52f7zpug/0cgz7fa5fl8ku3w/app-release+%281%29.apk" />
                                    <Foundation icon={<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2 9.5A3.5 3.5 0 005.5 13H9v2.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 15.586V13h2.5a4.5 4.5 0 10-.616-8.958 4.002 4.002 0 10-7.753 1.977A3.5 3.5 0 002 9.5zm9 3.5H9V8a1 1 0 012 0v5z" clip-rule="evenodd"></path></svg>} name="Windows mining" url="https://download1480.mediafire.com/5jjbh2uxfzhg/ljndgfwopazc1ud/Kakitu+Miner.zip" />
                                </Menu.Items>
                            </Transition>
                        </Menu>
